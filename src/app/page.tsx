...
export default function Home() {
	...
	const PainterCard = () => (
		<Card hover className="transform transition-all duration-300 flex flex-col">
			<CardHeader>
				<h2 className="text-2xl font-semibold text-indigo-700">For Painters</h2>
			</CardHeader>
	...
	return (
		<div className="container mx-auto px-4 py-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-20">
				...
				{currentUser?.role?.toLowerCase() === 'painter' && <PainterCard />}
				{currentUser?.role?.toLowerCase() === 'customer' && <CustomerCard />}
			</div>
		</div>
	)
}
